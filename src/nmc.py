...
class NMC:
    ...
    def __init__(self, robust_estimation=False):
        """"Create the NMC object: True use medians to estimate centroids, mean otherwise"""
        self._robust_estimation = robust_estimation
    ...
    def fit(self, x_tr, y_tr):
        ...
        for k in range(n_classes):
            xk = x_tr[y_tr == k, :]
            if self._robust_estimation is False:
